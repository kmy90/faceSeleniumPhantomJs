...
const config_controler_1 = require("./config_controler");
const RE_USE = 'RE-USE';
...
class OauthController {
    ...
    static obtain_admin_token_ru(admin_name, admin_pass) {
        return new Promise((resolve, reject) => {
            if (admin_name != config_controler_1.default.oauth_admin_name ||
                admin_pass != config_controler_1.default.oauth_admin_pass)
                return resolve(null);
